...
SOURCES =tetrisModel.mli tetrisModel.ml ui.ml
...
CAMLC = ocamlc -g -I +lablGL lablglut.cma lablgl.cma  
CAMLOPT = ocamlopt
CAMLDEP = ocamldep
CAMLLEX = ocamllex
CAMLYACC = ocamlyacc
...
WITHGL=-I +lablGL lablglut.cma lablgl.cma  
